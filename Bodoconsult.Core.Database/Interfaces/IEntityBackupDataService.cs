...
namespace Bodoconsult.Core.Database.Interfaces
{
    ...
    public interface IEntityBackupDataService<T> where T : class
    {
        ...
        /// <summary>
        /// Format the entity as a line with semicolon separated fields (CSV)
        /// </summary>
        /// <param name="entity">Entity to serialize</param>
        /// <param name="stringBuilder">StringBuikder to append the data</param>
        void FormatAsString(T entity, StringBuilder stringBuilder);
